...
echo -e $MSG
docker run -v ${SRC}:/src -i --privileged -p 445:445 -p 4001:4001 -p 127.0.0.1:5001:5001 -p 2222:2222 -p 8080:8080 -p 8181:8181 -p 8545:8545 -t countzen/blackops:latest
